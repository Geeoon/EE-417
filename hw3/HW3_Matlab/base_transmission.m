...
alpha = 0.5; % alpha of sqrt raised cosine filter (try 0.2, as well as 0.0 and 1.0)
...
delay = 1/3; % Offset from optimum sampling point (as fraction of symbol period). Try either 0 or 1/3
